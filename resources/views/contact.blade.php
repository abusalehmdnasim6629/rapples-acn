                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <form method="POST" class="lgx-contactform" action="php/form-handler.php">
                            ...
                            <div class="form-group">
							 ...
							 <div class="form-group">
                                <input type="text" name="lgxemail" class="form-control lgxemail" id="lgxemail" placeholder="Enter Ibo No. (for Current IBOs)" required>
                            </div>
							
							 <div class="form-group">
                                <input type="text" name="lgxemail" class="form-control lgxemail" id="lgxemail" placeholder="Enter Up-line TC (for Current IBOs)" required>
                            </div>						
